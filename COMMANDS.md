...
> **Ambiguity rule (global):** The pronouns _"it"_, _"that"_, _"the shape"_,
> _"this"_, and _"the selected one"_ always resolve to the **currently-selected
...
- Multiple style properties may be voiced in one utterance:
  _"Make it a thick red circle"_ → `STYLE_SHAPE {color:"red", strokeWidth:"thick"}`.
